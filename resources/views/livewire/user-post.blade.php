<div>
   ...
   <div class="flex flex-col overflow-y-scroll min-h-0 relative no-scrollbar w-full" style=" gap:20px;max-height:600px">
    ...
    <div class=" mt-5 rounded-lg shadow-lg" style="background-color:#00B8A9">
        <div class="m-3 shadow-2xl" style="min-height:100px;max-height:500px;">
            ...
            <div class="flex justify-between"><a href="/profile/{{$user->id}}"><h1 class="font-bold pt-1 flex">
                ...
                <img src="{{URL('storage/'.$post->user->displaypicture)}}" alt="" style="height: 30px;width:30px;border-radius:100%;margin-left:5px; {{$user->active_status == 'Online' ? 'border:2px solid green;' : 'border:2px solid blue;'}}">    
                @else
        ...
        <span class="ml-2 mt-0.5">{{ $user->name }}</span> </h1></a> 
                <form action="/delete/post/{{$post->id}}" method="post">
                    @method("DELETE")

                    @csrf
                <button type="submit"><svg xmlns="http://www.w3.org/2000/svg" height="25" viewBox="0 96 960 960" width="25"><path d="M261 936q-24.75 0-42.375-17.625T201 876V306h-41v-60h188v-30h264v30h188v60h-41v570q0 24-18 42t-42 18H261Zm438-630H261v570h438V306ZM367 790h60V391h-60v399Zm166 0h60V391h-60v399ZM261 306v570-570Z"/></svg></button>
            </form>
        </div>
    ...
    @endif
    <a href="/profile/{{$comment->user->id}}"><p class="break-words pt-1 font-bold pl-2"> {{$comment->user->name }} </p></a></li>
